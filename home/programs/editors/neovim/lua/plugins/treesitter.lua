-- nvim-treesitter configuration for MASTER branch (stable)
-- Using master instead of main to avoid query/parser version mismatches

return {
  "nvim-treesitter/nvim-treesitter",
  build = function()
    -- Defer TSUpdate to avoid build-time API errors
    -- The available_parsers() API isn't ready during lazy.nvim's build phase
    vim.defer_fn(function()
      vim.cmd("TSUpdate")
    end, 100) -- 100ms delay to ensure plugin is fully loaded
  end,
